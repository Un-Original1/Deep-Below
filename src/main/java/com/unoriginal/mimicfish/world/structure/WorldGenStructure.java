...
public class WorldGenStructure extends WorldGenerator implements IStructure {
    ...
    private Template getTemplate(World world) {
        ...
        ResourceLocation location = new ResourceLocation(Mimicfish.MODID , structureName);
    ...
    public int getYGenHeight(World world, int x, int z) {
        ...
        return StructureUtil.getAverageGroundHeight(world, x, z, templateSize.getX(), templateSize.getZ(), this.getMaxVariation(world));
    }
